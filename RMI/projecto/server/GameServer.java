...
public class GameServer {
    ...
    public static FroggerGameImpl getFroggerGame(int id) throws RemoteException {
        for (FroggerGameImpl f : froggerGameArrayList) {
            if (f.getId() == id) {
                return f;
            }
        }
    ...
    /**
     * Adiciona Frogger ao array de Froggers
     * @param froggerGame
     */
    public static void addFrogger(FroggerGameImpl froggerGame) throws RemoteException{
        froggerGameArrayList.add(froggerGame);
    }

    /**
     * Remove Frogger do array de Froggers
     * @param id
     */
    public static boolean deleteFroggerGame(int id) throws RemoteException {
        FroggerGameImpl froggerGame = getFroggerGame(id);
        if (froggerGame != null){
            froggerGameArrayList.remove(froggerGame);
            return true;
        }
        return false;
    }
