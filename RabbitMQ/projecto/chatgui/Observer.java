...
public class Observer {
    ...
    public Observer(ObserverGuiClient gui, String host, int port, String user, String pass, int idJogador, String exchangeName, BuiltinExchangeType exchangeType, String messageFormat) throws IOException, TimeoutException {
        this.gui = gui;
        ...
        this.sendMessage(idJogador + ":Boas");
    }
    ...
    private void bindExchangeToChannelRabbitMQ() throws IOException {
        ...
        channelToRabbitMq.exchangeDeclare(exchangeName + "client", BuiltinExchangeType.FANOUT);
    }
    ...
    public void attachConsumerToChannelExchangeWithKey() {
        try {
            ...
            String routingKey = "";
            channelToRabbitMq.queueBind(queueName, exchangeName + "client", routingKey);
    ...
    public void setReceivedMessage(String receivedMessage) throws IOException {
        ...
        if (string[1].equals("Down Pressed") || string[1].equals("Up Pressed") || string[1].equals("Right Pressed") || string[1].equals("Left Pressed")) {
            gui.getMain().recebeState(string[1]);
        }
